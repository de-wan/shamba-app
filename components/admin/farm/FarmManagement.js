    ...
    return(
        <View style={styles.mainContainer}>
            ...
            <View style={{ width:'90%', height:90, borderRadius:10, backgroundColor:"#3CB371", flexDirection:'column', justifyContent:'space-around', paddingHorizontal:10, marginBottom:20}}>
                <Text style={{textAlign:'center', fontWeight:"bold", color:'#fff', fontSize:18}}>3491</Text>
                <Text style={{textAlign:'center', color:'#fff'}}>Total Registered Livestock</Text>
            </View>
            ...
            <ScrollView contentContainerStyle={{width:'100%', flexDirection:"column", alignItems:'center', justifyContent:"center"}}>
                {livestock.map(livestock => (
                    <View style={{height:70, borderColor:"#90ee91",borderBottomWidth:1, width:'95%', borderRadius:10, paddingHorizontal:10, marginBottom:5,  flexDirection:"row",justifyContent:"space-between", alignItems:'center'}} >    
                        ...
                        <View style={{width:'70%', justifyContent:'flex-start'}}>
                            ...
                            <Text>Registered No: {livestock.registeredNo}</Text>
                ...
                {crops.map(crop => (
                    <View style={{height:90, borderColor:"#90ee91",borderBottomWidth:1, width:'95%', borderRadius:10, paddingHorizontal:10, marginBottom:5,  flexDirection:"row",justifyContent:"space-between", alignItems:'center'}} >    
                        ...
                        <View style={{width:'30%', height:'100%',flexDirection:"column", justifyContent:"space-between"}}>
                            <TouchableOpacity style={{width:100, height:30, backgroundColor:'#E55451', borderRadius:20, marginTop:10}} onPress={() => setCalendarModal(true)}>
        ...
        <ScrollView>
            ...
            >
                <View>
                    ...
                    <View style={{width:"90%", height: 80, marginTop:10, paddingLeft:20}}>
                        <Text>Category:</Text> 
                        <TextInput style={styles.inputField} placeholder='Contagious'/>
                    </View>
                    <View style={{width:"90%", height: 140, flexDirection:"row",justifyContent:"space-between", marginVertical:20,  paddingLeft:20}}>
                        <TouchableOpacity 
            ...
            <View style={styles.mainContainer}>                
                ...
                <View style={{ width:'90%', height:90, borderRadius:10, backgroundColor:"#3CB371", flexDirection:'column', justifyContent:'space-around', paddingHorizontal:10}}>
                    <Text style={{textAlign:'center', color:'#fff'}}>Total Reported Diseases</Text>
                    <Text style={{textAlign:'center', fontWeight:"bold", color:'#fff', fontSize:18}}>34</Text>
                </View>
                <View style={{width:'100%', height:40, justifyContent:"center", alignItems:'flex-end', paddingRight:20}}>
                    <TouchableOpacity
                ...
                <ScrollView contentContainerStyle={{width:'100%', flexDirection:"column", alignItems:'center', justifyContent:"center"}}>
                    {diseases.map(disease => (
                        <View style={{height:80, borderColor:"#90ee91",borderBottomWidth:1, width:'95%', borderRadius:10, paddingHorizontal:10, marginBottom:5,  flexDirection:"row",justifyContent:"space-between", alignItems:'center'}} >    
