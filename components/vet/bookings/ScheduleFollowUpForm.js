...
const ScheduleFollowUpForm = ({ navigation }) => {
  ...
  return (
    <View style={styles.main}>
      ...
      <View style={styles.inputWrap}>
        <ShambaInput label="Description" inputType="textarea" placeholder="Enter Description" />
      </View>
      <View style={styles.inputWrap}>
        <ShambaButton text="Schedule Follow Up" />
      </View>
    </View>
  );
};
